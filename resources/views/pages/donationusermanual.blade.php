...
<br>
<br>
<div style="text-align:center"><h1> Bağış Paketleri Kullanım Kılavuzu </h1></div> 
<hr>


<ul class="list-group">
        <li class="list-group-item list-group-item-info"><a class="btn info">
            1. Web Sitemize Girdiğiniz Anda Üst Menüde Bulunan " Bağış Paketleri " Kısmına Tıklıyoruz.
        </a></li>
        
</ul>
<ul class="list-group">
        <li class="list-group-item list-group-item-info"><a class="btn info">
            2. Açılan Sayfada 4 (Dört) Adet Sabit Bağış Paketi Bulunmaktadır.
        </a></li>
        
</ul>
<ul class="list-group">
        <li class="list-group-item list-group-item-info"><a class="btn info">
            3. Bu Bağış Paketlerinden İstediğinizi Seçerek " Bağış Yap " Butonuna Bastığınız anda " Ödeme Sayfasına " Yönlendirilirsiniz.
        </a></li>
        
</ul>
<ul class="list-group">
        <li class="list-group-item list-group-item-info"><a class="btn info">
            4. Ödeme işlemini Gerçekleştirdikten Sonra Başarı İle Bağış Yapmış Olursunuz. 
        </a></li> 
